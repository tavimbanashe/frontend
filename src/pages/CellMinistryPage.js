...
const CellMinistryPage = () => {
    ...
    const fetchMinistries = async () => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/cell-ministries`);
    ...
    const handleSubmit = async () => {
        ...
        const url = formValues.id
            ? `${process.env.REACT_APP_API_BASE_URL}/api/cell-ministries/${formValues.id}`
            : `${process.env.REACT_APP_API_BASE_URL}/api/cell-ministries`;
        try {

...
const AttendancePage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const eventsResponse = await fetch(`${process.env.REACT_APP_API_BASE_URL}/attendance/events`);
                const attendanceResponse = await fetch(`${process.env.REACT_APP_API_BASE_URL}/attendance/records`);
                const membersResponse = await fetch(`${process.env.REACT_APP_API_BASE_URL}/members`);
    ...
    const handleEventSubmit = async () => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/attendance/events`, {
                method: 'POST',
    ...
    const handleAttendanceSubmit = async () => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/attendance/records`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },

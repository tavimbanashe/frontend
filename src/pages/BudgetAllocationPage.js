...
const BudgetAllocationPage = () => {
    ...
    useEffect(() => {
        const fetchBudgets = async () => {
            try {
                const budgetsResponse = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/budgets`);
                const summaryResponse = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/budgets/summary`);
    ...
    const handleAddBudget = async () => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/budgets`, {
                method: 'POST',

...
const CounselingPage = () => {
    ...
    const fetchCounselors = async () => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/members/counseling/counselors`);
    ...
    const fetchSessions = async () => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/members/counseling/sessions`);
            const data = await response.json();
            setSessions(data);
        } catch (error) {
    ...
    const handleSave = async () => {
        ...
        const endpoint = selectedItem
            ? `${process.env.REACT_APP_API_BASE_URL}/api/members/counseling/${modalType === 'counselor' ? 'counselors' : 'sessions'}/${selectedItem.id}`
            : `${process.env.REACT_APP_API_BASE_URL}/api/members/counseling/${modalType === 'counselor' ? 'counselors' : 'sessions'}`;
    ...
    const handleDelete = async (type, id) => {
        try {
            await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/members/counseling/${type}/${id}`, {
                method: 'DELETE',
            });
